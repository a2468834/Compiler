...
{
       0,    31,    31,    36,    45,    55,    58,    65,    75,    78,
      84,    88,    95,    98,   105,   114,   119,   121,   126,   134,
     136,   141,   150,   153,   156,   159
};
#endif
...
{
  "$end", "error", "$undefined", "TOK_PROGRAM", "TOK_VAR", "TOK_ARRAY",
  "TOK_OF", "TOK_INTEGER", "TOK_REAL", "TOK_FUNCTION", "TOK_PROCEDURE",
  "TOK_BEGIN", "TOK_END", "TOK_IF", "TOK_THEN", "TOK_ELSE", "TOK_WHILE",
  "TOK_DO", "TOK_NOT", "TOK_ASSIGN_OP", "TOK_REL_OP", "TOK_DOTDOT",
  "TOK_ID", "TOK_INT_NUM", "TOK_REAL_NUM", "'+'", "'-'", "'*'", "'/'",
  "'['", "']'", "'('", "')'", "','", "';'", "':'", "'.'", "$accept",
  "goal", "program", "program_head", "identifier_list",
  "variable_declaration", "type", "compound_statement", "statement_list",
...
static const yytype_uint16 yytoknum[] =
{
     ...
     275,   276,   277,   278,   279,    43,    45,    42,    47,    91,
      93,    40,    41,    44,    59,    58,    46
};
# endif
...
{
      -1,   -15,    17,   -28,    21,    -5,   -28,     5,    18,     5,
     -28,   -27,   -11,    -8,   -23,     8,     6,   -28,    12,   -12,
     -28,   -28,    -2,   -28,   -28,   -28,     0,   -19,   -28,    11,
     -28,   -28,   -28,   -28,   -28,   -19,   -28,   -10,    -9,   -28,
     -28,     3,   -19,   -19,   -19,   -19,   -28,    -9,    -9,   -28,
     -28
};
...
static const yytype_uint8 yydefact[] =
{
      ...
      12,     3,     0,     6,     8,     9,     0,     0,    11,     0,
       4,     7,    22,    23,    24,     0,    14,    15,    16,    19,
      13,     0,     0,     0,     0,     0,    25,    17,    18,    20,
      21
};
...
{
      28,    17,     1,    32,    33,    34,    15,     5,    16,    22,
      15,    18,    35,    24,    25,    42,    43,     6,    44,    45,
      47,    48,    29,    49,    50,     7,     9,    10,    21,    12,
      23,    27,    30,    18,    31,    46,    14,    41,    40
};

static const yytype_uint8 yycheck[] =
{
      12,    12,     3,    22,    23,    24,    33,    22,    35,    32,
      33,    22,    31,     7,     8,    25,    26,     0,    27,    28,
      42,    43,    34,    44,    45,     4,    31,    22,    36,    11,
      22,    19,    34,    22,    34,    32,     9,    35,    29
};
...
{
       0,     3,    38,    39,    40,    22,     0,     4,    42,    31,
      22,    41,    11,    44,    41,    33,    35,    12,    22,    45,
      46,    36,    32,    22,     7,     8,    43,    19,    12,    34,
      34,    34,    22,    23,    24,    31,    47,    48,    49,    50,
      46,    47,    25,    26,    27,    28,    32,    49,    49,    50,
      50
};
...
#line 106 "parse.y" /* yacc.c:1646  */
    { (yyval.node) = newNode(NODE_ASSIGN_STMT);
          addChild((yyval.node), (yyvsp[-2].node));
          addChild((yyval.node), (yyvsp[0].node));
          (yyvsp[-2].node)->nodeType = NODE_SYM_REF;
          deleteNode((yyvsp[-1].node)); }
...
#line 151 "parse.y" /* yacc.c:1646  */
    { (yyval.node) = (yyvsp[0].node); 
          (yyval.node)->nodeType = NODE_VAR_OR_PROC; }
