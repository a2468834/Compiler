...
#line 135 "yacc.tab.c" /* yacc.c:355  */
};
...
#line 152 "yacc.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "ID", "NUMBER", "PLUS", "MINUS",
  "MULTIPLY", "DIVIDE", "SEMICOLON", "$accept", "program", "statement",
...
#line 60 "yacc.y" /* yacc.c:1646  */
    {
            ...
            addChild((yyval.node), (yyvsp[0].node));
            struct nodeType* expr = (yyval.node);
            (yyval.node) = newNode(NODE_EXPR);
            addChild((yyval.node), expr);
...
#line 69 "yacc.y" /* yacc.c:1646  */
    {
        ...
        addChild((yyval.node), newNode(OP_ADD));
        addChild((yyval.node), (yyvsp[0].node));
...
#line 77 "yacc.y" /* yacc.c:1646  */
    {
        ...
        (yyval.node) = newNode(NODE_EXPR);
        addChild((yyval.node), (yyvsp[-2].node));
        addChild((yyval.node), newNode(OP_SUB));
        addChild((yyval.node), (yyvsp[0].node));
...
#line 1319 "yacc.tab.c" /* yacc.c:1646  */
    break;
