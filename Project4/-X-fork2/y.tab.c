...
static const yytype_uint16 yyrline[] =
{
     ...
     160,   167,   178,   186,   195,   207,   216,   228,   236,   245,
     254,   268,   275,   284,   293,   302,   309,   320,   329,   335,
     341,   350,   359,   368,   379,   388,   397,   404,   416,   423,
     434,   440,   452,   458,   470,   476,   488,   496,   504,   510,
     516,   527,   533,   543,   549,   559,   565,   571,   577,   583,
     589,   599,   611,   618,   627
};
#endif
...
#line 91 "./parser.y" /* yacc.c:1646  */
    {
      (yyval.node) = newNode(NODE_identifier_list, line_no);
...
#line 109 "./parser.y" /* yacc.c:1646  */
    {
      ...
      GenGlobalVar((yyvsp[-3].node), (yyvsp[-1].node));
...
#line 186 "./parser.y" /* yacc.c:1646  */
    {
      (yyval.node) = newNode(NODE_subprogram_declarations, line_no);
...
#line 246 "./parser.y" /* yacc.c:1646  */
    {
      (yyval.node) = newNode(NODE_parameter_list, line_no);
      addChild((yyval.node), (yyvsp[-2].node));
      addChild((yyval.node), (yyvsp[0].node));
      //deleteNode($1);
...
#line 275 "./parser.y" /* yacc.c:1646  */
    {
      (yyval.node) = newNode(NODE_optional_var, line_no);
...
#line 303 "./parser.y" /* yacc.c:1646  */
    {
      (yyval.node) = newNode(NODE_statement_list, line_no);
      addChild((yyval.node), (yyvsp[0].node));
...
#line 359 "./parser.y" /* yacc.c:1646  */
    {
      (yyval.node) = newNode(NODE_statement, line_no);
...
#line 417 "./parser.y" /* yacc.c:1646  */
    {
      (yyval.node) = newNode(NODE_expression_list, line_no);
      addChild((yyval.node), (yyvsp[0].node));
...
#line 612 "./parser.y" /* yacc.c:1646  */
    {
      (yyval.node) = newOpNode(OP_MINUS, line_no);
      addChild((yyval.node), (yyvsp[0].node));
...
#line 619 "./parser.y" /* yacc.c:1646  */
    {
      ...
      (yyval.node)->rValue = (double) (yyvsp[0].string);
